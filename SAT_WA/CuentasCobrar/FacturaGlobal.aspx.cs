    ...
    public partial class FacturaGlobal : System.Web.UI.Page
    {
        ...
        protected void lkbImportarArchivo_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(Session["id_registro"]) > 0)
                ...
                TSDK.ASP.ScriptServer.AbreNuevaVentana(string.Format("ImportadorTarifaCobro.aspx?idFacturaGlobal={0}", Session["id_registro"]), "Importación de Tarifa de Cobro", 1080, 620, false, false, false, true, true, true, Page);
        }
        /// <summary>
        ...
        protected void lnkRegistrarFacturacionElectronica_Click(object sender, EventArgs e)
        {
            ...
            using (SAT_CL.Facturacion.FacturaGlobal objFacturaGlobal = new SAT_CL.Facturacion.FacturaGlobal((Convert.ToInt32(Session["id_registro"]))))
            {
                ...
                SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogo(ddlCuenta, 42, "NO IDENTIFICADO", 25, "", objFacturaGlobal.id_compania_cliente, "");
            }
        ...
        private RetornoOperacion registraFacturacionElectronica()
        {
            ...
            using (SAT_CL.Facturacion.FacturaGlobal objFacturaGlobal = new SAT_CL.Facturacion.FacturaGlobal(Convert.ToInt32(Session["id_registro"])))
            {
                ...
                {
                    //Registramos Factura
                    resultado = objFacturaGlobal.ImportaFacturaGlobal_V3_2(Convert.ToDecimal(txtTotalFactura.Text), Convert.ToByte(ddlFormaPago.SelectedValue), Convert.ToInt32(ddlCuenta.SelectedValue), Convert.ToByte(ddlMetodoPago.SelectedValue), Convert.ToByte(ddlCondicionesP.SelectedValue), Convert.ToInt32(ddlSucursal.SelectedValue),
        ...
        private RetornoOperacion actualizaComentario()
        {
            ...
            using (Comprobante objComprobante = new Comprobante(FacturadoFacturacion.ObtieneFacturaElectronicaFacturaGlobal(Convert.ToInt32(Session["id_registro"]))))
            {
                //Validamos Factura Electrónica
                if (objComprobante.id_comprobante > 0)
                {
                    //Obteniendo Referencias
                    using (DataTable dtRef = SAT_CL.Global.Referencia.CargaReferencias(objComprobante.id_comprobante, 119, SAT_CL.Global.ReferenciaTipo.ObtieneIdReferenciaTipo(0, 119, "Comentario", 0, "Facturacion Electrónica")))
                    {
                        ...
                        else
                        {
                            ...
                            resultado = SAT_CL.Global.Referencia.InsertaReferencia(objComprobante.id_comprobante, 119, SAT_CL.Global.ReferenciaTipo.ObtieneIdReferenciaTipo(0, 119, "Comentario", 0, "Facturacion Electrónica"),
        ...
        protected void lkbAddendaFacturaElectronica_Click(object sender, EventArgs e)
        {
            ...
            using (SAT_CL.Facturacion.FacturaGlobal objFacturaGlobal = new SAT_CL.Facturacion.FacturaGlobal(Convert.ToInt32(Session["id_registro"])))
            {
                ...
                if (objFacturaGlobal.id_factura_global > 0)
                {
                    ...
                    using (SAT_CL.FacturacionElectronica.Comprobante comp = new SAT_CL.FacturacionElectronica.Comprobante(objFacturaGlobal.id_factura_electronica))
                    {
                        //CargaCatalogo
        ...
        protected void btnAceptarTimbrarFacturacionElectronica_Click(object sender, EventArgs e)
        {
            ...
            {
                //Registramos Factura
                resultado = objFacturaGlobal.TimbraFacturaGlobal_V3_2(txtSerie.Text, chkOmitirAddenda.Checked,  HostingEnvironment.MapPath("~/XSLT/FacturacionElectronica/cadenaoriginal_3_2.xslt"),
        ...
        protected void btnAceptarAddenda_Click(object sender, EventArgs e)
        {
            ...
            if (ddlAddenda.SelectedValue != "0")
            {
                ...
                using (SAT_CL.Facturacion.FacturaGlobal Fac = new SAT_CL.Facturacion.FacturaGlobal(Convert.ToInt32(Session["id_registro"])))
                {
                    ...
                    if (Fac.id_factura_electronica > 0)
                    {
        ...
        protected void lkbVerComprobante_Click(object sender, EventArgs e)
        {
            ...
            using (Comprobante objComprobante = new Comprobante(FacturadoFacturacion.ObtieneFacturaElectronicaFacturaGlobal(Convert.ToInt32(Session["id_registro"]))))
            {
                ...
                {
                    //Obteniendo Ruta
                    string urlReporte = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/CuentasCobrar/FacturaGlobal.aspx", "~/FacturacionElectronica/Comprobante.aspx");

                    //Estatus de Lectura
                    Session["estatus"] = Pagina.Estatus.Lectura;

                    //Instanciando nueva ventana de navegador para apertura de registro
                    Response.Redirect(string.Format("{0}?idRegistro={1}", urlReporte, objComprobante.id_comprobante));
                }
                else
                    //Mostrando Notificación
        ...
        private void cargaCatalogos()
        {
            ...
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlTamanoFacConceptos, "", 3182);
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlTamanoFacDisp, "", 3182);
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlTamanoFacLigadas, "", 3182);
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlMetodoPago, "", 80);
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlFormaPago, "", 1099);
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlCondicionesP, "", 23);
            ...
            SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlTamanoReferencias, "", 3182);
            //Inicializamos Valor
        ...
        {   
            //Construyendo URL 
            string url = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/CuentasCobrar/FacturaGlobal.aspx", "~/Accesorios/BitacoraRegistro.aspx?idT=" + idTabla + "&idR=" + idRegistro + "&tB=" + Titulo);
        ...
        {   
            ...
            //Construyendo URL 
            string url = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/CuentasCobrar/FacturaGlobal.aspx", "~/Accesorios/AbrirRegistro.aspx?P1=" + idCompania.ToString());
        ...
        {   
            ...
            string urlDestino = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/CuentasCobrar/FacturaGlobal.aspx", "~/Accesorios/ReferenciaRegistro.aspx?idT=" + id_tabla + "&idR=" + id_registro + "&idC=" + id_compania);
        ...
        private void inicializaValoresRegistroFacturacionElectronica()
        {
            ...
            ddlCondicionesP.SelectedValue = "1";
        ...
        private void descargarXML()
        {
            ...
            using (SAT_CL.Facturacion.FacturaGlobal objFacturaGlobal = new SAT_CL.Facturacion.FacturaGlobal(Convert.ToInt32(Session["id_registro"])))
            {
                ...
                if (objFacturaGlobal.id_factura_electronica > 0)
                {
                    ...
                    using (SAT_CL.FacturacionElectronica.Comprobante c = new SAT_CL.FacturacionElectronica.Comprobante(objFacturaGlobal.id_factura_electronica))
                    {
                        ...
                        if (c.generado)
                        {
                            ...
                            if (cfdi_xml.Length > 0)
                            {
                                ...
                                using (SAT_CL.Global.CompaniaEmisorReceptor em = new SAT_CL.Global.CompaniaEmisorReceptor(c.id_compania_emisor))
                                    TSDK.Base.Archivo.DescargaArchivo(cfdi_xml, string.Format("{0}{1}_{2}.xml", c.serie, c.folio, em.rfc), TSDK.Base.Archivo.ContentType.binary_octetStream);
                            }
                        }
                    }
                }
        ...
        protected void lkbPDF_Click(object sender, EventArgs e)
        {
            ...
            string urlReporte = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/CuentasCobrar/FacturaGlobal.aspx", "~/RDLC/Reporte.aspx");
            //Instanciamos Fcatura Global
            using (SAT_CL.Facturacion.FacturaGlobal objFacturaGlobal = new SAT_CL.Facturacion.FacturaGlobal(Convert.ToInt32(Session["id_registro"])))
            {
                //Validamos que exista Factura Electrónica
                ...
                {
                    //Instanciamos Comprobante
                    using (SAT_CL.FacturacionElectronica.Comprobante objComprobante = new SAT_CL.FacturacionElectronica.Comprobante(objFacturaGlobal.id_factura_electronica))
                    {
                        //Validamos que el comprobante se encuentre Timbrado
                        if (objComprobante.id_comprobante > 0)
                        {
                            //Instanciando nueva ventana de navegador para apertura de registro
                            TSDK.ASP.ScriptServer.AbreNuevaVentana(string.Format("{0}?idTipoReporte={1}&idRegistro={2}", urlReporte, "Comprobante", objFacturaGlobal.id_factura_electronica), "Comprobante", "location=NO,toolbar=NO,scrollbars=YES,menubar=NO,status=YES,width=800,height=500", Page);
                        }
                    }
                }
            }
