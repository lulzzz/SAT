<%@ Page Title="Control de Acceso" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ControlAcceso.aspx.cs" Inherits="SAT.ControlPatio.ControlAcceso" %>
...
<ContentTemplate>
<asp:LinkButton ID="lnkMasUnidades" runat="server" Text="Mas Unidades" TabIndex="12"
...
<div class="renglon2x">
<div class="etiqueta">
<label for="txtTransportista" style="visibility:collapse;">Transportista</label>
</div>
<div class="control2x">
<asp:UpdatePanel ID="uptxtTransportista" runat="server" UpdateMode="Conditional">
<ContentTemplate>
<asp:TextBox ID="txtTransportista" runat="server" CssClass="textbox2x validate[required, custom[IdCatalogo]]" 
TabIndex="6" Visible="false" Text="TEM ID:2"></asp:TextBox>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
<asp:AsyncPostBackTrigger ControlID="lnkMasUnidades" />
...
<div class="renglon3x">
<div class="etiqueta">
<asp:UpdatePanel ID="uplblTag" runat="server" UpdateMode="Conditional">
<ContentTemplate>
...
<ContentTemplate>
<asp:TextBox ID="txtTag" runat="server" CssClass="textbox2x validate[required]" OnTextChanged="txtTag_TextChanged" AutoPostBack="true" TabIndex="7" ON
...
<ContentTemplate>
<asp:TextBox ID="txtDescripcion" runat="server" CssClass="textbox2x validate[required]" TabIndex="7"
MaxLength="150"></asp:TextBox>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
...
<asp:AsyncPostBackTrigger ControlID="btnAgregar" />
<asp:AsyncPostBackTrigger ControlID="gvEntidades" />
<asp:AsyncPostBackTrigger ControlID="txtTag" />
</Triggers>
</asp:UpdatePanel>
</div>
...
<ContentTemplate>
<asp:Button ID="btnAgregar" runat="server" TabIndex="12" CssClass="boton_agregar_unidad" OnClick="btnAgregar_Click" />
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
<asp:AsyncPostBackTrigger ControlID="lnkMasUnidades" />
...
<ContentTemplate>
<asp:Label ID="lblIdentificador" runat="server" Text="Placas"></asp:Label>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
<asp:AsyncPostBackTrigger ControlID="lnkMasUnidades" />
...
<ContentTemplate>
<asp:TextBox ID="txtIdentificador" runat="server" CssClass="textbox2x validate[required]" TabIndex="8"
MaxLength="150"></asp:TextBox>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
...
<ContentTemplate>
<asp:DropDownList ID="ddlEstado" runat="server" TabIndex="9" CssClass="dropdown2x"></asp:DropDownList>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
<asp:AsyncPostBackTrigger ControlID="lnkMasUnidades" />
...
<ContentTemplate>
<asp:TextBox ID="txtSTag" runat="server" CssClass="textbox2x validate[required]" OnTextChanged="txtSTag_TextChanged" AutoPostBack="true" TabIndex="7" 
MaxLength="150"></asp:TextBox>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnEntrar" />
