<%@ Page Title="Reporte de Cajones" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteCajones.aspx.cs" Inherits="SAT.ControlPatio.ReporteCajones" %>
...
<asp:LinkButton runat="server" ID="lnkOcupados" OnClick="lnkIndicadores_Click" CommandName="Ocupados" CssClass="indicador">
...
<asp:LinkButton runat="server" ID="lnkDisponibles" OnClick="lnkIndicadores_Click" CommandName="Disponibles" CssClass="indicadorL">
<div class="numero_indicador">
...
<asp:LinkButton runat="server" ID="lnkTiempoPromedio" OnClick="lnkIndicadores_Click" CommandName="TiempoPromedio" CssClass="indicador_texto">
...
<asp:LinkButton runat="server" ID="lnkUtilizacion" OnClick="lnkIndicadores_Click" CommandName="Utilizacion" CssClass="indicador">
<div class="numero_indicador">
...
<asp:AsyncPostBackTrigger ControlID="lnkBuscar" />
<asp:AsyncPostBackTrigger ControlID="lnkDisponibles" />
<asp:AsyncPostBackTrigger ControlID="lnkOcupados" />
...
<Triggers>
<asp:AsyncPostBackTrigger ControlID="gvCajones" EventName="Sorting" />
</Triggers>
</asp:UpdatePanel>
</div>
...
<asp:UpdatePanel ID="upgvCajones" runat="server" UpdateMode="Conditional">
<ContentTemplate>
<asp:GridView ID="gvCajones" runat="server" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true"
OnSorting="gvCajones_Sorting" OnPageIndexChanging="gvCajones_PageIndexChanging"
OnRowDataBound="gvCajones_RowDataBound"
PageSize="25" Width="100%" CssClass="gridview">
<AlternatingRowStyle CssClass="gridviewrowalternate" />
<EmptyDataRowStyle BackColor="#ffffff" ForeColor="#ff0000" />
<FooterStyle CssClass="gridviewfooter" />
...
<div id="contenidoBitacoraCajones" class="modal">
<div id="bitacoraCajones" class="contenedor_ventana_confirmacion">
<div class="header_seccion">
...
<asp:AsyncPostBackTrigger ControlID="gvCajones" />
<asp:AsyncPostBackTrigger ControlID="btnCerrar" />
</Triggers>
</asp:UpdatePanel>
</div>
