<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteLiquidacion.aspx.cs" Inherits="SAT.Liquidacion.ReporteLiquidacion" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvLiquidacion" CssClass="gridview" OnPageIndexChanging="gvLiquidacion_OnpageIndexChanging" OnSorting="gvLiquidacion_Onsorting" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PagoViajes" HeaderText="Pago Viajes" SortExpression="PagoViajes" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                            ...
                            <asp:BoundField DataField="SubsidioAlEmpleado" HeaderText="Subsidio Al Empleado" SortExpression="SubsidioAlEmpleado" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
