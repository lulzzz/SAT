...
{
    public partial class ReporteLiquidacion12 : System.Web.UI.Page
    {
        #region Eventos
        /// <summary>
        ...
        {
            //Construyendo URL 
            string url = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/Liquidacion/ReporteLiquidacion12.aspx", "~/Accesorios/BitacoraRegistro.aspx?idT=" + id_tabla + "&idR=" + id_registro + "&tB=" + nombre_tabla);
        ...
        private void sumaTotales()
        {
            ...
            {
                //Mostrando Totales
                gvLiquidacion.FooterRow.Cells[8].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Diesel)", "")));
                gvLiquidacion.FooterRow.Cells[9].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(SueldoFijo)", "")));
                gvLiquidacion.FooterRow.Cells[10].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(PagosViajes)", "")));
                gvLiquidacion.FooterRow.Cells[11].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(OtrosConceptos)", "")));
                gvLiquidacion.FooterRow.Cells[12].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Estadias)", "")));
                gvLiquidacion.FooterRow.Cells[13].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(BonoSemanal)", "")));
                gvLiquidacion.FooterRow.Cells[14].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Otros)", "")));
                gvLiquidacion.FooterRow.Cells[15].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Comprobaciones)", "")));
                gvLiquidacion.FooterRow.Cells[16].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Depositos)", "")));
                gvLiquidacion.FooterRow.Cells[17].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(IMSS)", "")));
                gvLiquidacion.FooterRow.Cells[18].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(ISR)", "")));
                gvLiquidacion.FooterRow.Cells[19].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(INFONAVIT)", "")));
                gvLiquidacion.FooterRow.Cells[20].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Prestamo)", "")));
                gvLiquidacion.FooterRow.Cells[21].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Deducciones)", "")));
                gvLiquidacion.FooterRow.Cells[22].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(Total)", "")));
                gvLiquidacion.FooterRow.Cells[23].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(NominaBasica)", "")));
                gvLiquidacion.FooterRow.Cells[24].Text = string.Format("{0:C2}", Convert.ToDecimal(((DataSet)Session["DS"]).Tables["Table"].Compute("SUM(NominaComplementaria)", "")));
            }
            else
            {
                ...
                gvLiquidacion.FooterRow.Cells[24].Text = string.Format("{0:C2}", 0);
            }
        }
        #endregion
