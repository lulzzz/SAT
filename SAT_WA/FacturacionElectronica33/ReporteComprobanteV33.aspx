<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteComprobanteV33.aspx.cs" Inherits="SAT.FacturacionElectronica33.ReporteComprobanteV33" %>
<%@ Register Src="~/UserControls/wucEmailCFDIV3_3.ascx" TagPrefix="uc1" TagName="wucEmailCFDI" %>
...
ConfiguraJQueryComprobante();
    ...
    <div class="contenedor_seccion_completa">
        ...
        <div id="contenedorReporteComprobantes" class="grid_seccion_completa_altura_variable">
            <asp:UpdatePanel ID="upgvComprobantes" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gvComprobantes" runat="server" TabIndex="16"
                        ...
                        ShowFooter="True" PageSize="250" AutoGenerateColumns="False" OnRowDataBound="gvComprobantes_RowDataBound">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                            ...
                            <asp:TemplateField HeaderText="Consulta Cancelación">
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbAccionCancelacion" runat="server" OnClick="imbAccionCFDI_Click" 
                                        ImageUrl="~/Image/cfdi_cancelacion.png" Width="25" Height="25" CommandName="Cancelacion" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Validacion SAT">
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbAccionValidacion" runat="server" OnClick="imbAccionCFDI_Click" 
                                        ImageUrl="~/Image/cfdi_consulta.png" Width="25" Height="25" CommandName="Validacion" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnAceptarValidacionSAT" />
                    <asp:AsyncPostBackTrigger ControlID="btnValidacionSAT" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </div>
    <div class="seccion_controles">
        ...
        <div class="renglon2x">
            <div class="celda_etiqueta">
                <label class="Label" for="rdbPDF"></label>
            </div>
    ...
    <!-- Ventana de Consulta de Cancelación -->
    <div id="contenedorVentanaConsultaAcuseCancelacion" class="modal">
        <div id="ventanaConsultaAcuseCancelacion" class="contenedor_ventana_confirmacion">
            <div class="columna2x">
                <div class="header_seccion">
                    <asp:UpdatePanel ID="upheaderValidacionSAT" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <img id="imgAcuseSAT" runat="server" src="../Image/Exclamacion.png" />
                            <h2 id="headerAcuseSAT" runat="server">Resultado de Validación Servidores SAT</h2>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                        </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblEstatusSAT">Estatus SAT</label>
                    </div>
                    <div class="etiqueta_80px">
                        <asp:UpdatePanel ID="uplblEstatusSAT" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblEstatusSAT" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                    ...
                    <div class="etiqueta_50px">
                        <label for="lblEsCancelableAC">Tipo</label>
                    </div>
                    <div class="etiqueta_155px">
                        <asp:UpdatePanel ID="uplblEsCancelableAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblEsCancelableAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblRFCEmisorAC">Emisor</label>
                    </div>
                    <div class="etiqueta_320px">
                        <asp:UpdatePanel ID="uplblRFCEmisorAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblRFCEmisorAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblRFCReceptorAC">Receptor</label>
                    </div>
                    <div class="etiqueta_320px">
                        <asp:UpdatePanel ID="uplblRFCReceptorAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblRFCReceptorAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblUUIDAC">UUID</label>
                    </div>
                    <div class="etiqueta_320px">
                        <asp:UpdatePanel ID="uplblUUIDAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblUUIDAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblFechaExpedicionAC">Fecha Expedición</label>
                    </div>
                    <div class="etiqueta_320px">
                        <asp:UpdatePanel ID="uplblFechaExpedicionAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblFechaExpedicionAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="etiqueta">
                        <label for="lblTotalFacturaAC">Total Factura</label>
                    </div>
                    <div class="etiqueta_320px">
                        <asp:UpdatePanel ID="uplblTotalFacturaAC" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="lblTotalFacturaAC" runat="server" CssClass="label_negrita"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="gvComprobantes" />
                            </Triggers>
                ...
                <div class="renglon2x">
                    <div class="controlBoton">
                        <asp:UpdatePanel ID="upbtnAceptarValidacionSAT" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="btnAceptarValidacionSAT" runat="server" CssClass="boton"
                                    OnClick="btnAceptarValidacionSAT_Click" Text="Aceptar" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </div>
