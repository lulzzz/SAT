...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fideicomisonoempresarial="http://www.sat.gob.mx/Fideicomisonoempresarial">
  ...
  <xsl:template match="fideicomisonoempresarial:IngresosOEntradas">
    ...
    <xsl:if test="./fideicomisonoempresarial:IngresosOEntradas/fideicomisonoempresarial:IntegracIngresos">
      <xsl:call-template name="Requerido">
  ...
  <xsl:template match="fideicomisonoempresarial:DeduccOSalidas">
    ...
    <!--
			Llamadas para procesar al los sub nodos del DeduccOSalidas
		-->
    <xsl:if test="./fideicomisonoempresarial:DeduccOSalidas/fideicomisonoempresarial:IntegracEgresos">
      <xsl:call-template name="Requerido">
        <xsl:with-param name="valor" select="./fideicomisonoempresarial:ConceptoS"/>
      </xsl:call-template>
    </xsl:if>    
  </xsl:template>
