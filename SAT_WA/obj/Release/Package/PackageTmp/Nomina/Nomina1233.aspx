<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="Nomina1233.aspx.cs" Inherits="SAT.Nomina.Nomina1233" %>

<%@ Register Src="~/UserControls/wucEmailCFDI.ascx" TagPrefix="uc1" TagName="wucEmailCFDI" %>
<%@ Register Src="~/UserControls/wucEmailCFDIV3_3.ascx" TagPrefix="tectos" TagName="wucEmailCFDIv3_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="server">
  ...
  <div class="seccion_controles">
      ...
      <div class="renglon2x">
        ...
        <div class="control_100px">
          <asp:UpdatePanel ID="uptxtVersion" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
              <b>
                <asp:TextBox ID="txtVersion" CssClass="textbox" Enabled="false" runat="server" Text="1.2"></asp:TextBox></b>
            </ContentTemplate>
            <Triggers>
              <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
              <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
    ...
    <div class="columna2x">
      ...
      <div class="renglon2x">
        <div class="etiqueta">
          <label for="ddlFormaPago">Método de Pago</label>
        </div>
        <div class="control">
          <asp:UpdatePanel ID="upddlFormaPago" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
              <asp:DropDownList ID="ddlFormaPago" runat="server" CssClass="dropdown" TabIndex="9"></asp:DropDownList>
            </ContentTemplate>
            <Triggers>
              <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
              <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
    ...
    <div class="grid_seccion_completa_400px_altura">
      ...
      <asp:UpdatePanel ID="upgvNominaEmpleado" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
          <asp:GridView ID="gvNominaEmpleado" runat="server" AllowPaging="True" AllowSorting="True" PageSize="25"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="SalarioDI" HeaderText="Salario D. Int." SortExpression="SalarioDI" DataFormatString="{0:C2}">
                <ItemStyle HorizontalAlign="Right" />
                <FooterStyle HorizontalAlign="Right" />
              </asp:BoundField>
              <asp:BoundField DataField="SalarioCA" HeaderText="Salario Cot. Apr." SortExpression="SalarioCA" DataFormatString="{0:C2}">
                <ItemStyle HorizontalAlign="Right" />
                <FooterStyle HorizontalAlign="Right" />
              </asp:BoundField>
              ...
              <asp:TemplateField HeaderText="Separacion Indemnizacion" SortExpression="SeparacionIndemnizacion">
                <ItemStyle HorizontalAlign="Right" />
                <FooterStyle HorizontalAlign="Right" />
                <ItemTemplate>
                  <asp:LinkButton ID="lnkSeparacionIndemnizacion" runat="server" CommandName="SeparacionIndemnizacion" Text='<%# string.Format("{0:C2}", Eval("SeparacionIndemnizacion")) %>' OnClick="lnkSeparacionIndemnizacion_Click"></asp:LinkButton>
                </ItemTemplate>
              </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="Hrs Extra" SortExpression="HrsExtra">
                <ItemStyle HorizontalAlign="Right" />
                <FooterStyle HorizontalAlign="Right" />
                <ItemTemplate>
        ...
        <Triggers>
          ...
          <asp:AsyncPostBackTrigger ControlID="btnAceptarCancelarNomina" />
          <asp:AsyncPostBackTrigger ControlID="btnSIGuardar" />
        </Triggers>
      </asp:UpdatePanel>
    </div>
  </div>
  ...
  <!--Ventana SeparacionIndemnizacion-->
  <div id="contenedorVentanaSeparacionIndemnizacion" class="modal">
    <div id="ventanaSeparacionIndemnizacion" class="contenedor_modal_seccion_completa" style="width: 810px;">
      <div class="boton_cerrar_modal" style="width: 800px;">
        <asp:UpdatePanel runat="server" ID="uplnkSICerrarModal" UpdateMode="Conditional">
          <ContentTemplate>
            <asp:LinkButton ID="lnkCerrarSeparacionIndemnizacion" runat="server" OnClick="lnkCerrar_Click" CommandName="SeparacionIndemnizacion" Text="Cerrar" TabIndex="17">
              <img src="../Image/Cerrar16.png" />
            </asp:LinkButton>
          </ContentTemplate>
        </asp:UpdatePanel>
      </div>
      <div class="header_seccion" style="width: 800px; margin: 0; padding: 0;">
        <h2>Separación e Indemnización</h2>
      </div>
      <div class="columna">
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="ddlSIConcepto">Concepto</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="upddlSIConcepto" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:DropDownList ID="ddlSIConcepto" runat="server" CssClass="dropdown"></asp:DropDownList>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
                ...
                <asp:AsyncPostBackTrigger ControlID="gvNominaEmpleado" />
                <asp:AsyncPostBackTrigger ControlID="btnSIGuardar" />
                <asp:AsyncPostBackTrigger ControlID="gvDetalleNominaSI" />
              </Triggers>
            </asp:UpdatePanel>
          </div>
        </div>
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="txtSIIngresoGravado">Importe Gravado</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="uptxtSIIngresoGravado" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:TextBox runat="server" ID="txtSIIngresoGravado" CssClass="textbox validate[required, custom[positiveNumber]]" OnTextChanged="txtSIIngresoGravado_TextChanged" AutoPostBack="true"></asp:TextBox>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
          ...
          <div class="renglon">
            <div class="etiqueta_155px">
              <label for="txtSITotalPagado">Total Pagado</label>
            </div>
            <div class="control">
              <asp:UpdatePanel ID="uptxtSITotalPagado" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                  <asp:TextBox runat="server" ID="txtSITotalPagado" CssClass="textbox" Enabled="false"></asp:TextBox>
                </ContentTemplate>
                <Triggers>
                  <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                  <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
        ...
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="txtSIAnosServicio">Años de Servicio</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="uptxtSIAnosServicio" UpdateMode="Conditional" runat="server">
              <ContentTemplate>
                <asp:TextBox ID="txtSIAnosServicio" CssClass="textbox validate[required, custom[integer]]" runat="server" Enabled="false"></asp:TextBox>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
        ...
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="txtSIUltimoSueldoO">Último Sueldo</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="uptxtSIUltimoSueldoO" UpdateMode="Conditional" runat="server">
              <ContentTemplate>
                <asp:TextBox ID="txtSIUltimoSueldoO" CssClass="textbox" Enabled="false" runat="server"></asp:TextBox>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
        ...
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="txtSIIngresoAcumulable">Ingreso Acumulable</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="uptxtSIIngresoAcumulable" UpdateMode="Conditional" runat="server">
              <ContentTemplate>
                <asp:TextBox ID="txtSIIngresoAcumulable" CssClass="textbox" Enabled="false" runat="server"></asp:TextBox>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
                ...
                <asp:AsyncPostBackTrigger ControlID="btnSIGuardar" />
                <asp:AsyncPostBackTrigger ControlID="gvDetalleNominaSI" />
                <asp:AsyncPostBackTrigger ControlID="txtSIIngresoGravado" />
              </Triggers>
            </asp:UpdatePanel>
          </div>
        </div>
        <div class="renglon">
          <div class="etiqueta_155px">
            <label for="txtSIIngresoNoAcumulable">Ingreso No Acumulable</label>
          </div>
          <div class="control">
            <asp:UpdatePanel ID="uptxtSIIngresoNoAcumulable" UpdateMode="Conditional" runat="server">
              <ContentTemplate>
                <asp:TextBox ID="txtSIIngresoNoAcumulable" CssClass="textbox" Enabled="false" runat="server"></asp:TextBox>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lkbNuevo" />
                <asp:AsyncPostBackTrigger ControlID="lkbGuardar" />
        ...
        <div class="renglon">
          <div class="controlBoton">
            <asp:UpdatePanel ID="upbtnSIGuardar" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:Button ID="btnSIGuardar" runat="server" Text="Guardar" OnClick="btnSIGuardar_Click" CssClass="boton" />
              </ContentTemplate>
              <Triggers></Triggers>
            </asp:UpdatePanel>
          </div>
          <div class="controlBoton">
            <asp:UpdatePanel ID="upbtnSICancelar" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:Button ID="btnSICancelar" runat="server" Text="Cancelar" OnClick="btnSICancelar_Click" CssClass="boton_cancelar" />
              </ContentTemplate>
              <Triggers></Triggers>
            </asp:UpdatePanel>
          </div>
      ...
      <div class="columna2x">
        <div class="renglon2x">
          <div class="etiqueta_50px">
            <label for="ddlSITamano">Mostrar:</label>
          </div>
          <div class="control_100px">
            <asp:UpdatePanel ID="upddlSITamano" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:DropDownList ID="ddlSITamano" runat="server" CssClass="dropdown_100px" OnSelectedIndexChanged="ddlSITamano_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="gvNominaEmpleado" />
              </Triggers>
          ...
          <div class="etiqueta">
            <asp:UpdatePanel ID="uplblSIOrdenado" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <b>
                  <asp:Label ID="lblSIOrdenado" runat="server"></asp:Label>
                </b>
              </ContentTemplate>
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="gvDetalleNominaSI" EventName="Sorting" />
              </Triggers>
            </asp:UpdatePanel>
          </div>
          <div class="etiqueta_50px">
            <asp:UpdatePanel ID="uplnkSIExportar" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:LinkButton ID="lnkSIExportar" runat="server" CommandName="SeparacionIndemnizacion" Text="Exportar" OnClick="lnkExportar_Click"></asp:LinkButton>
              </ContentTemplate>
              <Triggers></Triggers>
            </asp:UpdatePanel>
          </div>
        ...
        <div class="grid_seccion_completa_150px_altura">
          <asp:UpdatePanel ID="upgvSIdetalles" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
              <asp:GridView ID="gvDetalleNominaSI" runat="server" AllowPaging="true" AllowSorting="true" OnRowDataBound="gvDetalleNominaSI_RowDataBound"
                CssClass="gridview" ShowFooter="true" TabIndex="28" OnSorting="gvDetalleNominaSI_Sorting" PageSize="25"
                OnPageIndexChanging="gvDetalleNominaSI_PageIndexChanging" AutoGenerateColumns="false" Width="100%">
                <AlternatingRowStyle CssClass="gridviewrowalternate" />
                <EmptyDataRowStyle BackColor="#ffffff" ForeColor="#ff0000" />
                <FooterStyle CssClass="gridviewfooter" />
                <HeaderStyle CssClass="gridviewheader" />
                ...
                <SortedDescendingCellStyle CssClass="gridviewcellsortDESC" />
                <Columns>
                  <asp:BoundField DataField="IdNominaEmpleadoTER" HeaderText="IdNomEmpleado" Visible="false" SortExpression="IdNominaEmpleadoTER" />
                  <asp:BoundField DataField="IdEsquemaSuperiorTER" HeaderText="IdEsquemaSup" Visible="false" SortExpression="IdEsquemaSuperiorTER" />
                  <asp:BoundField DataField="TipoPercepcion" HeaderText="TipoPercepcion" SortExpression="TipoPercepcion" Visible="false" />
                  <asp:BoundField DataField="Clave" HeaderText="Clave" SortExpression="Clave" />
                  <asp:BoundField DataField="Concepto" HeaderText="Concepto" SortExpression="Concepto" />

                  <asp:BoundField DataField="ImporteGravado" HeaderText="Importe Gravado" SortExpression="ImporteGravado" DataFormatString="{0:C2}">
                    <ItemStyle HorizontalAlign="Right" Font-Bold="true" />
                    <FooterStyle HorizontalAlign="Right" />
                  </asp:BoundField>
                  <asp:BoundField DataField="ImporteExento" HeaderText="Importe Exento" SortExpression="ImporteExento" DataFormatString="{0:C2}">
                    <ItemStyle HorizontalAlign="Right" Font-Bold="true" />
                    <FooterStyle HorizontalAlign="Right" />
                  </asp:BoundField>
                  ...
                  <asp:TemplateField>
                    <ItemTemplate>
                      <asp:LinkButton ID="lnkEditarSI" runat="server" Text="Editar" OnClick="lnkEditarSI_Click"></asp:LinkButton>
                    </ItemTemplate>
                  </asp:TemplateField>
                  <asp:TemplateField>
                    <ItemTemplate>
                      <asp:LinkButton ID="lnkEliminarSI" runat="server" Text="Eliminar" OnClick="lnkEliminarSI_Click"></asp:LinkButton>
                    </ItemTemplate>
                  </asp:TemplateField>
                </Columns>
              </asp:GridView>
            ...
            <Triggers>
              ...
              <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
              <asp:AsyncPostBackTrigger ControlID="gvNominaEmpleado" />
              <asp:AsyncPostBackTrigger ControlID="ddlSITamano" />
              <asp:AsyncPostBackTrigger ControlID="btnSIGuardar" />
            </Triggers>
          </asp:UpdatePanel>
        </div>
  ...
  <!-- Ventana Confirmación Email del CFDI v3.3 -->
  <div id="contenedorVentanaEmailV33" class="modal">
    <div id="ventanaEmailV33" class="contenedor_ventana_confirmacion_arriba">
      <asp:UpdatePanel ID="upwucEmailCFDIv33" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
          <tectos:wucEmailCFDIv3_3 ID="wucEmailCFDIv3_3" runat="server" OnBtnEnviarEmail_Click="wucEmailCFDIv3_3_BtnEnviarEmail_Click"
            OnLkbCerrarEmail_Click="wucEmailCFDIv3_3_LkbCerrarEmail_Click" />
        </ContentTemplate>
        <Triggers>
          <asp:AsyncPostBackTrigger ControlID="gvNominaEmpleado" />
        </Triggers>
