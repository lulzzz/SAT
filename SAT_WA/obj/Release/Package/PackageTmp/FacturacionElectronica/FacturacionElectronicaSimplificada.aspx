<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPage.Master" CodeBehind="FacturacionElectronicaSimplificada.aspx.cs" Inherits="SAT.FacturacionElectronica.FacturacionElectronicaSimplificada" %>
...
<ContentTemplate>
<tectos:wucFacturadoConcepto ID="ucFacturadoConcepto" runat="server" OnClickGuardarFacturaConcepto="wucFacturadoConcepto_ClickGuardarFacturaConcepto" OnClickEliminarFacturaConcepto="wucFacturadoConcepto_ClickEliminarFacturaConcepto" TabIndex="9" />
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="gvServicioxFacturar" />
</Triggers>
