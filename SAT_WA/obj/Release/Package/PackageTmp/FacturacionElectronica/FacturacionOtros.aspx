<%@ Page Title="Facturación Otros" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FacturacionOtros.aspx.cs" Inherits="SAT.FacturacionElectronica.FacturacionOtros" %>
    ...
    <script type="text/javascript">
        ...
        function EndRequestHandler(sender, args) {
            if (args.get_error() == undefined) {
                ConfiguraJQueryFacturacionOtros();
            }
        }

        //Declarando Función de Configuración
        function ConfiguraJQueryFacturacionOtros() {
