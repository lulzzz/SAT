<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucFacturadoV3_3.ascx.cs" Inherits="SAT.UserControls.wucFacturadoV3_3" %>
...
ConfiguraJqueryWucFacturadoV3_3();
}
}
//Creando función para configuración de jquery en control de usuario
function ConfiguraJqueryWucFacturadoV3_3() {
...
<ContentTemplate>
<asp:DropDownList ID="ddlFormaPago" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFormaPago_SelectedIndexChanged"
CssClass="dropdown2x">
</asp:DropDownList>
</ContentTemplate>
<Triggers>
...
<ContentTemplate>
<asp:DropDownList ID="ddlMetodoPago" runat="server" CssClass="dropdown2x">
</asp:DropDownList>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnRegistrarFacturaElectronica" />
...
<div class="renglon2x">
<div class="etiqueta">
<label for="ddlCuenta">Uso CFDI</label>
</div>
<div class="control2x">
