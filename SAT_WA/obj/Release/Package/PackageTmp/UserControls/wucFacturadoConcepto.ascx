<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucFacturadoConcepto.ascx.cs" Inherits="SAT.UserControls.wucFacturadoConcepto" %>
...
ConfiguraJQueryControlFacturaConcepto();
}
}
//Creando función para configuración de jquery en control de usuario
function ConfiguraJQueryControlFacturaConcepto() {
