<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucEnvioEmail.ascx.cs" Inherits="SAT.UserControls.wucEnvioEmail" %>
<script type="text/javascript">
    ...
    function EndRequestHandler(sender, args) {
        if (args.get_error() == undefined) {
            ConfiguraJQueryEnvioEmail<%=this.ID%>();
        }
    }
    //Creando función para configuración de jquery en formulario
    function ConfiguraJQueryEnvioEmail<%=this.ID%>() {
