<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="PerfilSeguridadUsuario.aspx.cs" Inherits="SAT.Seguridad.PerfilSeguridadUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="server">
    <script type="text/javascript">
        ...
        function ConfiguraJQueryPerfilSeguridadUsuario() {
            $(document).ready(function () {
                ...
                $("#<%=txtUsuario.ClientID%>").autocomplete({ source: '../WebHandlers/AutoCompleta.ashx?id=33&param=<%= ((SAT_CL.Seguridad.UsuarioSesion)Session["usuario_sesion"]).id_compania_emisor_receptor.ToString() %>' });
                ...
                //Añadiendo Validación a Evento del Control
                $("#<%=lkbGuardar.ClientID%>").click(validaPerfilSeguridadUsuario);
            });
        }
    ...
    <div class="seccion_controles">
        <div class="columna2x">
            <div class="renglon2x">
                <div class="etiqueta">
                    <label for="lblPerfilID">Perfil de Usuario</label>
                </div>
                <div class="etiqueta_155px">
                    <asp:UpdatePanel ID="uplblPerfilUsuarioID" runat="server">
                        <ContentTemplate>
                            <b><asp:Label ID="lblPerfilUsuarioID" runat="server" Text="Por Asignar"></asp:Label></b>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnGuardar" />
                            <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
            ...
            <div class="renglon2x">
                ...
                <div class="control">
                    <asp:UpdatePanel ID="upddlPerfil" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlPerfil" runat="server" CssClass="dropdown" TabIndex="1"></asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnGuardar" />
                            <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
                ...
                <div class="etiqueta_155px">
                    <asp:UpdatePanel ID="upchkActivo" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
            ...
            <div class="renglon2x">
                ...
                <div class="control2x">
                    <asp:UpdatePanel ID="uptxtUsuario" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtUsuario" runat="server" CssClass="textbox2x validate[required, custom[IdCatalogo]]" TabIndex="2"></asp:TextBox>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnGuardar" />
                            <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
