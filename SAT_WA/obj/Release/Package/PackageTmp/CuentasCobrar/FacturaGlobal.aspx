<%@ Page Title="Factura Global" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FacturaGlobal.aspx.cs" Inherits="SAT.CuentasCobrar.FacturaGlobal" %>
...
<li>
<asp:LinkButton ID="lkbVerComprobante" runat="server" Text="Ver CFDI" OnClick="lkbVerComprobante_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbComentario" runat="server" Text="Comentario" OnClick="lkbComentario_Click"></asp:LinkButton></li>
</ul>
</li>
<li class="blue">
...
<li>
<asp:LinkButton ID="lkbAddendaFacturaElectronica" runat="server" Text="Addenda" OnClick="lkbAddendaFacturaElectronica_Click"></asp:LinkButton></li>
</ul>
</li>
<li class="gray">
...
<ul>
<li>
<asp:LinkButton ID="lkbRegistrarFacturaElectronica" runat="server" Text="Registrar" OnClick="lnkRegistrarFacturacionElectronica_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbTimbrarFacturaElectronica" runat="server" Text="Timbrar" OnClick="lnkTimbrarFacturacionElectronica_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbEliminarCFDI" runat="server" Text="EliminarCFDI" OnClick="lkbEliminarCFDI_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbCancelarCFDI" runat="server" Text="CancelarCFDI" OnClick="lkbCancelarCFDI_Click"></asp:LinkButton></li>
</ul>
</li>
<li class="yellow">
...
<ul>
<li>
<asp:LinkButton ID="lkbPDF" runat="server" Text="PDF" OnClick="lkbPDF_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbXML" runat="server" Text="XML" OnClick="lkbXML_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbEmail" runat="server" Text="E-mail" OnClick="lkbEmail_Click"></asp:LinkButton></li>
<li>
<asp:LinkButton ID="lkbFEReferencias" runat="server" Text="Referencias" OnClick="lkbFEReferencias_Click"></asp:LinkButton></li>
</ul>
</li>
</ul>
</nav>
...
<div class="controlr" style="width: 150px">
</div>
<div class="controlr" style="width: 140px">
</div>
<div class="controlr" style="width: 140px">
</div>
<div class="controlr" style="width: 140px">
...
<ContentTemplate>
<b>
<asp:Label ID="lblNoFactura" runat="server"></asp:Label></b>
</ContentTemplate>
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnGuardar" />
<asp:AsyncPostBackTrigger ControlID="btnCancelar" />
...
<ContentTemplate>
<asp:Button ID="btnCancelar" runat="server" Text="Cancelar" TabIndex="4" CssClass="boton_cancelar"
...
<ContentTemplate>
<asp:DropDownList ID="ddlTipoFacturacionElectronica" runat="server" OnSelectedIndexChanged="ddlTipoFacturacionElectronica_SelectedIndexChanged" AutoPostBack="true"
CssClass="dropdown2x">
</asp:DropDownList>
</ContentTemplate>
<Triggers>
...
<ContentTemplate>
<asp:DropDownList ID="ddlMetodoPago" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlMetodoPago_SelectedIndexChanged"
CssClass="dropdown2x">
</asp:DropDownList>
</ContentTemplate>
<Triggers>
...
<div class="renglon2x">
<div class="etiqueta">
<label for="ddlMetodoPago">Condiciones Pago</label>
</div>
<div class="control2x">
<asp:UpdatePanel ID="upddlCondicionesP" runat="server" UpdateMode="Conditional">
<ContentTemplate>
<asp:DropDownList ID="ddlCondicionesP" runat="server"
CssClass="dropdown2x">
</asp:DropDownList>
</ContentTemplate>
<Triggers>
...
<ContentTemplate>
<asp:DropDownList ID="ddlTamanoReferencias" runat="server" TabIndex="13" Enabled="false" OnSelectedIndexChanged="ddlTamanoReferencias_SelectedIndexChanged"
