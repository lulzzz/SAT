<%@ Page Title="Saldos Globales" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteSaldosGlobales.aspx.cs" Inherits="SAT.CuentasCobrar.ReporteSaldosGlobales" %>
...
<asp:Panel ID="pnlReporteSaldosGlobales" runat="server" DefaultButton="btnBuscar">
<div class="columna2x">
<div class="renglon2x">
<div class="etiqueta">
...
<div class="renglon2x">
<div class="etiqueta">
<label for="chkFacturacinE">Facturación Electrónica</label>
</div>
<div class="control">
<asp:UpdatePanel ID="upchkFacturacinE" runat="server" UpdateMode="Conditional">
<ContentTemplate>
<asp:CheckBox ID="chkFacturacinE" runat="server" TabIndex="2" />
</ContentTemplate>
</asp:UpdatePanel>
</div>
</div>
...
<ContentTemplate>
<asp:Button ID="btnBuscar" runat="server" Text="Buscar" TabIndex="4" CssClass="boton" OnClick="btnBuscar_Click" />
</ContentTemplate>
</asp:UpdatePanel>
</div>
</div>
...
<asp:BoundField DataField="TotalSinProceso" HeaderText="Total Sin Proceso" SortExpression="TotalSinProceso" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:C2}">
<FooterStyle HorizontalAlign="Right" />
</asp:BoundField>
<asp:BoundField DataField="TotalProcesoActual" HeaderText="Total Proceso Actual" SortExpression="TotalProcesoActual" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:C2}">
<FooterStyle HorizontalAlign="Right" />
</asp:BoundField>
<asp:BoundField DataField="TotalProcesoTerminado" HeaderText="Total Proceso Terminado" SortExpression="TotalProcesoTerminado" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:C2}">
<FooterStyle HorizontalAlign="Right" />
</asp:BoundField>
<asp:BoundField DataField="TotalFE" HeaderText="Total Fac. Electronica" SortExpression="TotalFE" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:C2}">
<FooterStyle HorizontalAlign="Right" />
</asp:BoundField>
