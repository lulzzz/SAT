...
{
    public partial class wucDeposito : System.Web.UI.UserControl
    {
        #region Atributos
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnClick_btnSolicitar(object sender, EventArgs e)
        {
            //Validando que exista un Evento
            if (ClickSolicitar != null)
                OnClickSolicitar(e);
        ...
        private void cargaCatalogos()
        {
            ...
            //        Controles.CargaDropDownList(ddlUbicaciones, dtUbicaciones, "id", "descripcion", );
            //    else
            //        Controles.InicializaDropDownList(ddlUbicaciones, "No tiene ubicaciones configuradas");
            //}
        }
        ...
        private void habilitaControles()
        {
                ...
                btnSolicitar.Visible = MuestraSolicitar;
        ...
        private void configuraControlFactura()
        {
            ...
            if (ddlConcepto.SelectedItem.Text.Contains("Diesel (Tractor)"))
                //Mostrando control
        ...
        /// </summary>
        /// <returns></returns>
        public RetornoOperacion DeshabilitaDeposito()
        {
            //Declaramos Mensaje
            RetornoOperacion resultado = new RetornoOperacion();
            ...
            if (this._id_deposito > 0)
            {
                ...
                using (Deposito objDeposito = new Deposito(this._id_deposito))
                {
                    ...
                    resultado = objDeposito.DeshabilitaDeposito(((Usuario)Session["usuario"]).id_usuario);
                }
            }
            //Devolvemos Valor
            return resultado;
                    ...
                    if (this._id_deposito == 0)
                    {
                        ...
                        if (this._id_movimiento_asignacion > 0)
                        {
                            ...
                            resultado = Deposito.InsertaDeposito(Convert.ToInt32(((UsuarioSesion)Session["usuario_sesion"]).id_compania_emisor_receptor), txtOperadorUnidad.Text,
                                                        ...
                                                        this._id_unidad, this._id_operador, this._id_proveedor_compania, this._id_servicio, this._id_movimiento_asignacion, Convert.ToDecimal(txtMonto.Text),
                                ...
                                using (Deposito objDeposito = new Deposito(resultado.IdRegistro))
                                {
                                    ...
                                    if (resultado.OperacionExitosa)
                                    {
                                        ...
                                        using (SAT_CL.EgresoServicio.ConceptoDeposito objConceptoDeposito = new ConceptoDeposito(Convert.ToInt32(ddlConcepto.SelectedValue)))
                                        {
                                            ...
                                            if (objConceptoDeposito.descripcion == "Diesel (Tractor)" || objConceptoDeposito.descripcion == "Diesel (Remolque)")
                                            {
                                                ...
                                                resultado = SAT_CL.EgresoServicio.AsignacionDiesel.InsertaValeDieselPorDeposito(txtOperadorUnidad.Text.ToUpper(),
                        ...
                        using (Deposito objDeposito = new Deposito(this._id_deposito))
                        {
                            ...
                            resultado = objDeposito.EditaDeposito(Convert.ToInt32(((UsuarioSesion)Session["usuario_sesion"]).id_compania_emisor_receptor),
                                                         ...
                                                         , txtReferencia.Text.ToUpper(), (Deposito.TipoCargo)Convert.ToByte(ddlTipoCargo.SelectedValue),
                                                             chkDepositoExtraEfectivo.Checked, ((Usuario)Session["usuario"]).id_usuario);
