<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucDeposito.ascx.cs" Inherits="SAT.UserControls.wucDeposito" %>
    ...
    <div class="columna3x">
                ...
                <asp:UpdatePanel ID="upddlConcepto" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlConcepto" runat="server" CssClass="dropdown2x" AutoPostBack="true" 
                            OnSelectedIndexChanged="ddlConcepto_SelectedIndexChanged"></asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnRegistrar" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
        ...
        <div class="renglon3x" style="width:600px">
                ...
                <asp:UpdatePanel ID="upbtnSolicitar" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Button ID="btnSolicitar" runat="server" Text="Solicitar" CssClass="boton" OnClick="OnClick_btnSolicitar" />
                    </ContentTemplate>
                    <Triggers>
                         <asp:AsyncPostBackTrigger ControlID="btnCancelar" />
                        <asp:AsyncPostBackTrigger ControlID="btnRegistrar" />
...
<!-- Ventana Factura -->
<div id="contenedorVentanaFacturaAnticipo" class="modal">
<div id="ventanaFacturaAnticipo" class="contenedor_ventana_confirmacion">
<div class="boton_cerrar_modal">
<asp:UpdatePanel ID="uplnkCerrarVentanaFL" runat="server" UpdateMode="Conditional">
<ContentTemplate>
<asp:LinkButton ID="lnkCerrarVentanaFL" runat="server" CommandName="FacturasLigadas" Text="Cerrar" OnClick="lnkCerrarVentanaFL_Click">
...
<h2>¿Desea agregar facturas al Servicio?</h2>
</div>
<div class="columna2x">
<div class="renglon2x">
<div class="controlBoton">
...
<ContentTemplate>
<asp:Button ID="btnAgregarFactura" runat="server" CssClass="boton" Text="Agregar" OnClick="btnAgregarFactura_Click" />
</ContentTemplate>
</asp:UpdatePanel>
</div>
</div>
