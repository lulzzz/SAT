...
{
    public partial class wucFacturado : System.Web.UI.UserControl
    {
        #region Atributos
        ...
        protected void ddlTipoComrobante_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //El tipo de Conprobante es Ingreso
                case 1:
                    //Instanciando Factura
                    using (Facturado fac = new Facturado(this.idFactura))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                //Cargando Cuentas Pago 
                                SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogo(ddlCuenta, 42, "NO IDENTIFICADO", 25, "", objFacturacionOtros.id_cliente_receptor, "");
                            }
                        }
                    }
                ...
                default:
                    ...
                    using (Facturado fac = new Facturado(this.idFactura))
                    {
                        ...
                        if (fac.id_servicio != 0)
                        {
                            ...
                            {
                                //Cargando Cuentas Pago 
                                SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogo(ddlCuenta, 42, "NO IDENTIFICADO", 25, "", objServicio.id_compania_emisor, "");
                            }
                        }
                        else
                        {
                            ...
                            {
                                //Cargando Cuentas Pago 
                                SAT_CL.CapaNegocio.m_capaNegocio.CargaCatalogo(ddlCuenta, 42, "NO IDENTIFICADO", 25, "", objFacturacionOtros.id_compania_emisora, "");
                            }
                        }
                    }
                    break;
        ...
        private RetornoOperacion RegistraFacturacionElectronica()
        {
            ...
            {
                //Registramos Factura
                resultado = objFacturado.ImportaFacturadoComprobante_V3_2(Convert.ToByte(ddlFormaPago.SelectedValue), Convert.ToInt32(ddlCuenta.SelectedValue), Convert.ToByte(ddlMetodoPago.SelectedValue), Convert.ToByte(ddlTipoComrobante.SelectedValue), Convert.ToInt32(ddlSucursal.SelectedValue),
        ...
        protected void btnAceptarTimbrarFacturacionElectronica_Click(object sender, EventArgs e)
        {
            ...
            //Registramos Factura
            resultado = objFacturado.TimbraFacturadoComprobante_V3_2(txtSerie.Text,chkOmitirAddenda.Checked,  HostingEnvironment.MapPath("~/XSLT/FacturacionElectronica/cadenaoriginal_3_2.xslt"),
        ...
        protected void lkbEmail_Click(object sender, EventArgs e)
        {
            ...
            using (SAT_CL.FacturacionElectronica.Comprobante comp = new SAT_CL.FacturacionElectronica.Comprobante(FacturadoFacturacion.ObtieneFacturacionElectronicaActiva(objFacturado.id_factura)))
            {
        ...
        {
            //Obteniendo Ruta
            string urlReporte = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/UserControls/wucFacturado.ascx", "~/RDLC/Reporte.aspx");
            ...
            using (FacturadoFacturacion objFacturaFacturacion = new FacturadoFacturacion((FacturadoFacturacion.ObtieneRelacionFactura(objFacturado.id_factura))))
            {
                ...
                if (objFacturaFacturacion.id_factura_electronica > 0)
                {
                    ...
                    using (SAT_CL.FacturacionElectronica.Comprobante objComprobante = new SAT_CL.FacturacionElectronica.Comprobante(objFacturaFacturacion.id_factura_electronica))
                    {
                        ...
                        {
                            //Obteniendo Ruta
                            string urlReporte = TSDK.Base.Cadena.RutaRelativaAAbsoluta("~/UserControls/wucFacturado.ascx", "~/FacturacionElectronica/Comprobante.aspx");
        ...
        {   
            ...
            if (objFacturado.id_factura != 0)
            {
                ...
                using (FacturadoFacturacion facturado = new FacturadoFacturacion((FacturadoFacturacion.ObtieneRelacionFactura(objFacturado.id_factura))))
                {
                    ...
                    if (facturado.id_factura_electronica > 0)
                    {
        ...
        {   
            ...
            CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlMonedaFactura, "", 11);
            ...
            CapaNegocio.m_capaNegocio.CargaCatalogoGeneral(ddlTipoComrobante, "", 1100);
            //Sucursales
