...
{
    public partial class wucEmailCFDI : System.Web.UI.UserControl
    {
        ...
        public RetornoOperacion EnviaEmail(bool xml, bool pdf)
        {
            ...
            if (resultado.OperacionExitosa)
            {
                ...
                if (comprobantes.Count == 1)
                {
                    ...
                    { 
                        //Enviando e mail
                        resultado = c.EnviaArchivosEmail(ViewState["_remitente"].ToString(), txtAsunto.Text, txtMensaje.Text, destinatarios, pdf, xml);
                    }
                }
                //Si hay más de uno
