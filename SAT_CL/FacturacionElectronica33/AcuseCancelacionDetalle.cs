...
{
    /// <summary>
    /// Clase encargada de gestionar todas las funciones de los Detalles del Acuse de Cancelación
    /// </summary>
    public class AcuseCancelacionDetalle : Disposable
    {
        ...
        public enum EstatusCancelacion
        {
            ...
            /// 
            /// </summary>
            CanceladoSinAceptacion = 1,
            /// <summary>
            /// 
            /// </summary>
            PendienteCancelacion = 2,
            /// <summary>
            /// 
            /// </summary>
            Aceptado = 3,
        ...
        /// </summary>
        private static string nom_sp = "fe33.sp_acuse_cancelacion_detalle_33_tacu";
        ...
        /// <summary>
        /// Atributo encargado de Obtener el Estatus (Enumeración)
        /// </summary>
        public EstatusCancelacion estatus
        {
            get { return (EstatusCancelacion)this._id_estatus_tacd; }
        }
        ...
        /// <param name="id_usuario_tacd"></param>
        /// <returns></returns>
        public RetornoOperacion ActualizaEstatusDetalle(EstatusCancelacion estatus, int id_usuario_tacd)
        {   //Regresando Resultado del SP
            return editaAtributos(this._id_acuse_cancelacion_tacd, this._id_timbre_fiscal_digital_tacd, (int)estatus,
                                                    id_usuario_tacd, this._habilitar_tacd);
        }
        ...
        /// <summary>
        /// Método encargado de Obtener el Detalle del Acuse dado un Timbre Fiscal
        /// </summary>
        /// <param name="id_timbre_fiscal_digital_tacd"></param>
        /// <returns></returns>
        public static AcuseCancelacionDetalle ObtieneAcuseTimbre(int id_timbre_fiscal_digital_tacd)
        {   
            //Declarando Objeto de Retorno
            AcuseCancelacionDetalle detalle = new AcuseCancelacionDetalle();
            
            //Declarando Parametros de Entrada
            object[] param = { 4, 0, 0, id_timbre_fiscal_digital_tacd, 0, 0, true, "", "" };
            ...
            {   
                ...
                if (Validacion.ValidaOrigenDatos(ds, "Table"))
                {
                    ...
                    foreach (DataRow dr in ds.Tables["Table"].Rows)
                    {
                        ...
                        detalle = new AcuseCancelacionDetalle(Convert.ToInt32(dr["Id"]));
                        //Terminando Ciclo
                        break;
                    }
                }
