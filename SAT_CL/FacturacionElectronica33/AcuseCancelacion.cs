...
{
    /// <summary>
    /// Clase encargada de gestionar todas las funciones del Acuse de Cancelación
    /// </summary>
    public class AcuseCancelacion : Disposable
    {
        ...
        /// Nombre del 
        /// </summary>
        private static string _nombre_stored_procedure = "fe33.sp_acuse_cancelacion_33_tacc";
        ...
        /// <summary>
        /// Versión del Comprobante del Acuse
        /// </summary>
            ...
            using (DataSet ds = CapaDatos.m_capaDeDatos.EjecutaProcAlmacenadoDataSet(_nombre_stored_procedure, param))
            {
                ...
                if (Validacion.ValidaOrigenDatos(ds, "Table"))
                {
                    ...
                    foreach (DataRow r in ds.Tables["Table"].Rows)
                    {
                        ...
                        this._version = r["Version"].ToString();
        ...
        /// <returns></returns>
        private RetornoOperacion actualizaRegistrosBD(string estatus, DateTime fecha, XDocument acuse_xml, string version, int id_usuario, bool habilitar)
        {
            //Inicializando parámetros de actualización
            object[] param = { 2, this._id_acuse_cancelacion, estatus, fecha, acuse_xml.ToString(), version, id_usuario, habilitar, "", "" };
        ...
        /// <param name="id_usuario">Id de Usuario</param>
        /// <returns></returns>
        public static RetornoOperacion InsertaAcuseCancelacion(string estatus, DateTime fecha, XDocument acuse_xml, string version, int id_usuario)
        {
            //Inicializando parámetros para insertar nuevo registro
            object[] param = { 1, 0, estatus, fecha, acuse_xml == null ? "" : acuse_xml.ToString(), version, id_usuario, true, "", "" };
        ...
        /// <param name="id_usuario">Id de Usuario</param>
        /// <returns></returns>
        public RetornoOperacion EditaAcuseCancelacion(string estatus, DateTime fecha, XDocument acuse_xml, string version, int id_usuario)
        {
            return actualizaRegistrosBD(estatus, fecha, acuse_xml, version, id_usuario, this._habilitar);
        }
        ...
        {
            return actualizaRegistrosBD(this._estatus, this._fecha, this._acuse_xml, this._version, id_usuario, false);
        }
