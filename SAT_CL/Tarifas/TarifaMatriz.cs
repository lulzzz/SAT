...
{
    /// <summary>
    /// Clase encargada de todas las Operaciones de las Matrices de las Tarifas
    /// </summary>
    public class TarifaMatriz : Disposable
    {
        ...
        /// </summary>
        private static string _nom_sp = "tarifas.sp_tarifa_matriz_ttm";
        ...
        {   //Declarando Objeto de Retorno
            ...
            object[] param = { 3, id_registro, 0, "", "", "", "", 0, 0, 0, 0, 0, true, "", "" };
        ...
        private RetornoOperacion actualizaRegistros(int id_tarifa, string valor_filtro_col, string valor_filtro_row, string valor_desc_col, string valor_desc_row,
                                                    int posicion_x, int posicion_y, decimal tarifa_cargado, decimal tarifa_vacio, int id_usuario, bool habilitar)
        {   //Declarando Objeto de Retorno
            RetornoOperacion result = new RetornoOperacion();
            //Armando Arreglo de Parametros
            object[] param = { 2, this._id_tarifa_matriz, id_tarifa, valor_filtro_col, valor_filtro_row, valor_desc_col, valor_desc_row,
                                 posicion_x, posicion_y, tarifa_cargado, tarifa_vacio, id_usuario, habilitar, "", "" };
            //Ejecutando SP
        ...
        public static RetornoOperacion InsertaTarifaMatriz(int id_tarifa, string valor_filtro_col, string valor_filtro_row, string valor_desc_col, string valor_desc_row,
                                                    int posicion_x, int posicion_y, decimal tarifa_cargado, decimal tarifa_vacio, int id_usuario)
        {   //Declarando Objeto de Retorno
            RetornoOperacion result = new RetornoOperacion();
            //Armando Arreglo de Parametros
            object[] param = { 1, 0, id_tarifa, valor_filtro_col, valor_filtro_row, valor_desc_col, valor_desc_row,
                                 posicion_x, posicion_y, tarifa_cargado, tarifa_vacio, id_usuario, true, "", "" };
            //Ejecutando SP
            result = CapaDatos.m_capaDeDatos.EjecutaProcAlmacenadoObjeto(_nom_sp, param);
            //Devolviendo Resultado Obtenido
            return result;
        ...
        {   //Invocando Método de Actualización
            return this.actualizaRegistros(id_tarifa, valor_filtro_col, valor_filtro_row, valor_desc_col, valor_desc_row,
                                 posicion_x, posicion_y, tarifa_cargado, tarifa_vacio, id_usuario, this._habilitar);
        }
        /// <summary>
        ...
        {   //Invocando Método de Actualización
            return this.actualizaRegistros(this._id_tarifa, this._valor_filtro_col, this._valor_filtro_row, this._valor_desc_col, this._valor_desc_row,
                                 this._posicion_x, this._posicion_y, this._tarifa_cargado, this._tarifa_vacio, id_usuario, false);
        }
        /// <summary>
        ...
        /// <summary>
        /// Método Público encargado de Obtener las Matrices ligadas a una Tarifa
        /// </summary>
        ...
        {   //Declarando OBjeto de Retorno
            DataTable dt = null;
            //Armando Arreglo de Parametros
            object[] param = { 4, 0, id_tarifa, "", "", "", "", 0, 0, 0, 0, 0, true, "", "" };
        ...
        {   //Declarando OBjeto de Retorno
            DataTable dt = null;
            //Armando Arreglo de Parametros
            object[] param = { 5, 0, id_tarifa, valor_filtro_col, valor_filtro_row, "", "", 0, 0, 0, 0, 0, true, "", "" };
            //Obteniendo Resultado de la Consulta
            using (DataSet ds = CapaDatos.m_capaDeDatos.EjecutaProcAlmacenadoDataSet(_nom_sp, param))
            {   //Validando que existan Registros
                if (TSDK.Datos.Validacion.ValidaOrigenDatos(ds, "Table"))
        ...
        {   //Armando Arreglo de Parametros
            object[] param = { 6, 0, id_tarifa, "", "", "", "", 0, 0, 0, 0, 0, true, "", "" };
            //Obteniendo Resultado de la Consulta
            using (DataSet ds = CapaDatos.m_capaDeDatos.EjecutaProcAlmacenadoDataSet(_nom_sp, param))
                //Devolviendo Resultado Obtenido
                return ds;
        ...
        {   
            ...
            object[] param = { 7, 0, id_tarifa, valor_filtro_col, valor_filtro_row, "", "", 0, 0, 0, 0, 0, true, operador_filtro_col, operador_filtro_row };
